...
export default function Press() {
  const mySlides: { img: StaticImageData, link: string, target: string, title: string, date: string, org: string, author: string, caption: string }[] = [
    { img: press3, link: "https://issuu.com/elsollatino/docs/el_sol_latino_august_2014_10.9/2", target: "_blank", title: "28vo Festival de la Familia Hispana Holyoke", date: "AUG 2014", org: "El Sol Latino", author: "", caption: "" },
    { img: press2, link: "https://www.masslive.com/elpueblolatino/2014/12/concierto_festivo_de_mambo_on.html", target: "_blank", title: "Concierto Festivo de \"Mambo on Main Street: A Latin Big Band Holyday\" todo un exito", date: "DEC 2014", org: "Mass Live", author: "Damaris Pérez-Pizarro", caption: "\"Otra cantante que también compartió tarima con la banda Creación Big Band fue la talentosísima jovencita Casey Ortiz, quien apenas con sus 12 años de edad tiene una poderosa voz que cautiva con su carismática personalidad y entusiasmo cantando en español los géneros de salsa y bolero. Ella interpreto varias canciones de cantantes como La Lupe, Cesar Portillo de la Luz, Rafael Cortijo y Rafael Hernández, entre otros.\"" },
    { img: press1, link: "https://issuu.com/elsollatino/docs/el_sol_latino_jan2015web_48d5088211e335", target: "_blank", title: "\"Mambo on Main Street\" un Éxito Musical y Cultural", date: "JAN 2015", org: "Mass Live", author: "Manuel Frau-Ramos", caption: "\"Twelve-year-old singer Casey Ortiz will lend her voice to the occasion...\"" },
    { img: press4, link: "https://www.facebook.com/share/p/15bKifhTtp/", target: "_blank",title: "Florence Summer Concert Series: Libro Azul", date: "AUG 2023", org: "Florence Civic & Business Association", author: "", caption: ""},
  ]
  return(
